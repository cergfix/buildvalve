...
export function PipelineRunPage() {
  ...
  // Two-step confirm for the destructive cancel: first click flips the
  // button to "confirm" for ~4s; second click in that window fires the
  ...
  const cancelMutation = useMutation({
    mutationFn: () => pipelinesApi.cancel(projectId!, runId!),
    onSuccess: () => {
